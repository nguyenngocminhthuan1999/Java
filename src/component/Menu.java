...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu("1", "Book Magenement", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("2", "Employee", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("3", "Rent/Borrow", Model_Menu.MenuType.MENU));
        ...
        listMenu1.addItem(new Model_Menu("", " ", Model_Menu.MenuType.EMPTY));
        listMenu1.addItem(new Model_Menu("", " ", Model_Menu.MenuType.EMPTY));
        listMenu1.addItem(new Model_Menu("4", "Change Password", Model_Menu.MenuType.MENU));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Newbies");
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/Book48.png")));
